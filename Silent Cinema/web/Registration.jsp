...
<body onload="exist()">
    ...
    <div class="container">
        ...
        <h1>CREATE ACCOUNT</h1>
            ...
            <input type="password" name = "pass" id = "pass" placeholder="PASSWORD" <% if (GlobalVariables.data[4] != null) { %> value="<%= GlobalVariables.data[4] %>" <% } %> oninput="keycolor()" onclick="toggle();">  
